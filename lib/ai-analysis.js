 ...
 */
const analyzeScreening = async (questions, jobDetails) => [
    {
        role: "system",
        content: `
...
const generateCoverLetter = async (
    ...
    interests) => [
    {
        role: "system",
        content: `
        You are an English Teaching cover letter expert 
        generating a cover letter for a user based on their profile and job requirements.
        `,
    },
    {
        role: "user",
        ...
        Here is the user's profile: ${JSON.stringify(userDetails)}.
        Here is the user's work experience: ${JSON.stringify(workExperience)}.
        Here is the user's education: ${JSON.stringify(education)}.
        Here is the user's skills: ${JSON.stringify(skills)}.
        Here is the user's interests: ${JSON.stringify(interests)}.
        `,
    },
];

const generateJobDescription = async (jobTitle, hours, jobType, workPermit, requirements, description, location, salary) => [
    {
        role: "system",
        content: `
